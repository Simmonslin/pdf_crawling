...
| 網頁 | 網頁內容|資料取得 | 請求帶入 |
|:----:|------|------|:----:|
| 1 | 電子資料查詢表單 | 填入公司代號 + 資料年度 + 資料類型 + 資料細節說明 |公司代號 = co_id <br> 資料年度 = year <br> 資料類型 = F <br> 資料細節說明=F04 
| 2 | bs4 | 解析 HTML 和 XML 文件 | 將複雜的網頁原始碼轉化為樹狀結構 | 搭配requests使用
| 3 | pdfplumber | 爬取pdf文件中的文字並匯總成 |  |
